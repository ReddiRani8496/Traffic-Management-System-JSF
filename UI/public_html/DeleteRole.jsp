...
<f:view>
  <html>
    ...
    <h:inputText id="roleName"
                 value="#{managedBean.rolename}" required="true" />

    <h:commandButton styleClass="centerButton" value="Delete"
                     action="#{managedBean.deleteRole}" />
</h:form>
...
<%-- oracle-jdev-comment:auto-binding-backing-bean-name:backing_DeleteRole--%>