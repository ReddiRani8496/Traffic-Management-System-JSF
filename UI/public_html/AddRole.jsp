...
<f:view>
  <html>
    ...
    <h:inputText id="roleDesc"
                 value="#{managedBean.mrole.roleDescription}" required="true" />

    <h:commandButton styleClass="centerButton" value="Create"
                     action="#{managedBean.addRole}" />
...
<%-- oracle-jdev-comment:auto-binding-backing-bean-name:backing_AddRole--%>