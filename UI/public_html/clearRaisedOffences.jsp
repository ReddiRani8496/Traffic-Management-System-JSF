...
<f:view>
  <af:document id="d1" binding="#{backing_clearRaisedOffences.d1}">
...
.ownerheader {
 ...
 <header>
    ...
    <af:form id="f1" binding="#{backing_clearRaisedOffences.f1}">
      <h:dataTable value="#{managedBean.listOfPendingOffences}" var="clear"
                   binding="#{backing_clearRaisedOffences.dt1}" id="dt1" styleClass="data-table table table-striped table-Secondary">
        <%-- 
        ...
        <h:column id="c8">
          <f:facet name="header">
            <h:outputText value="Select"
                          binding="#{backing_clearRaisedOffences.ot1}"
                          id="ot1"/>
          </f:facet>
        ...
        <h:column id="c3">
          <f:facet name="header">
            <h:outputText value="Offense Date Time"
                          binding="#{backing_clearRaisedOffences.ot2}"
                          id="ot2"/>
          </f:facet>
          <h:outputText value="#{clear.offenseDateTime}" id="ot11"/>
        </h:column>
        <h:column id="c4">
          <f:facet name="header">
            <h:outputText value="Offense Detail Id"
                          binding="#{backing_clearRaisedOffences.ot3}"
                          id="ot3"/>
          </f:facet>
          <h:outputText value="#{clear.offenseDetailId}" id="ot13"/>
        </h:column>
        <h:column id="c6">
          <f:facet name="header">
            <h:outputText value="Penalty Status"
                          binding="#{backing_clearRaisedOffences.ot4}"
                          id="ot4"/>
          </f:facet>
          <h:outputText value="#{clear.penaltyStatus}" id="ot12"/>
        </h:column>
        <h:column id="c5">
          <f:facet name="header">
            <h:outputText value="Place"
                          binding="#{backing_clearRaisedOffences.ot5}"
                          id="ot5"/>
          </f:facet>
          <h:outputText value="#{clear.place}" id="ot15"/>
        </h:column>
        <h:column id="c1">
          <f:facet name="header">
            <h:outputText value="Registrations"
                          binding="#{backing_clearRaisedOffences.ot6}"
                          id="ot6"/>
          </f:facet>
          <h:outputText value="#{clear.registrations.registrationId}" id="ot10"/>
        </h:column>
        <h:column id="c7">
          <f:facet name="header">
            <h:outputText value="Offence Types"
                          binding="#{backing_clearRaisedOffences.ot7}"
                          id="ot7"/>
          </f:facet>
          <h:outputText value="#{clear.offenceTypes.offenseId}" id="ot16"/>
        </h:column>
        <h:column id="c2">
          <f:facet name="header">
            <h:outputText value="Users"
                          binding="#{backing_clearRaisedOffences.ot8}"
                          id="ot8"/>
          </f:facet>
          <h:outputText value="#{clear.users.userId}" id="ot14"/>
        </h:column>
      </h:dataTable>
      <h:commandButton value="Clear Offences" id="cb1"
                       action="#{managedBean.cb1_action4}" 
...
<%-- oracle-jdev-comment:auto-binding-backing-bean-name:backing_clearRaisedOffences--%>