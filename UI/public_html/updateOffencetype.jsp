    ...
    <body>
       <header>
            ...
            <div class="right-side">
                ...
                <div id="addOffence">
            <h2 class="arvo-bold-italic">Update Offence Type</h2>
            <h:messages   />
         <h:form>  
  
    <div class="update-row">
        <label for="offenceId">Offence ID</label>
        <h:inputText id="offenceId" value="#{managedBean.offenceRef.offenseId}" styleClass="input-text"/>
         <h:commandButton id="searchButton" value="Search" styleClass="button"
                          action="#{managedBean.searchOffenseType}"/>                    
    </div>
    </h:form>
     <h:form>
    <h:outputLabel for="offenceID">Offence ID <span class="mandatory">*</span>:</h:outputLabel><br />
    <h:inputText id="offenceID" value="#{managedBean.offenceRef.offenseId}"  styleClass="dis"/><br />
    
    <h:outputLabel for="offenceType">Offence Type <span class="mandatory">*</span>:</h:outputLabel><br />
    <h:inputText id="offenceType" value="#{managedBean.offenceRef.offenseName}"  styleClass="dis" /><br />
    
    <h:outputLabel for="vehicleType">Vehicle Type <span class="mandatory">*</span>:</h:outputLabel><br />
    <h:inputText id="vehicleType" value="#{managedBean.offenceRef.vehicleType}" required="true" /><br />
    
    <h:outputLabel for="penalty">Penalty <span class="mandatory">*</span>:</h:outputLabel><br />
    <h:inputText id="penalty" value="#{managedBean.offenceRef.penalty}" required="true" /><br />
    
    <h:commandButton value="update" action="#{managedBean.updateOffenseType}" styleClass="Update"/>
