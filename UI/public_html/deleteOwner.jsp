...
<f:view>
  <af:document id="d1" title="deleteOwner">
  <style type="text/css">
    .container {
        max-width: 1000px;
        margin: 10px auto;
...
.ownerheader {
  ...
  <div class="container">
    <h1 class="arvo-bold-italic">Delete Owner</h1>
      <h:messages   />
    <h:form id="f2">  
    
    <div class="update-row">
        <label for="offenceId">Owner ID</label>
        <h:inputText id="offenceId" value="#{managedBean.ownerRef1.ownerId}" styleClass="input-text"/>
         <h:commandButton id="searchButton" value="Search" styleClass="button"
                          action="#{managedBean.searchOwnersId1}"/>                    
    </div>
    ...
    <h:form id="f1">
      ...
      <div class="form-row">
        <div class="form-column">
            ...
            <div class="form-group">
                ...
                <h:inputText styleClass="input-text" id="it1" value="#{managedBean.ownerRef1.ownerId}"
                              />
            </div>
      
            <div class="form-group">
                <label for="it2">Owner ID Type</label>
                <h:inputText  styleClass="input-text" id="it2" value="#{managedBean.ownerRef1.idType}"/>
            </div>
      
            <div class="form-group">
                <label for="it3">First Name</label>
                <h:inputText id="it3" value="#{managedBean.ownerRef1.firstName}"  styleClass="input-text"/>
            </div>
      
            <div class="form-group">
                <label for="it4">Last Name</label>
                <h:inputText id="it4" value="#{managedBean.ownerRef1.lastName}"  styleClass="input-text"/>
            </div>
        ...
        <div class="form-column">
            <div class="form-group">
                ...
                <h:inputText id="it5" value="#{managedBean.ownerRef1.gender}"  styleClass="input-text"/>
            </div>
      
            <div class="form-group">
                <label for="it7">Phone Number</label>
                <h:inputText id="it7" value="#{managedBean.ownerRef1.phoneNumber}"  styleClass="input-text"/>
            </div>
      
            <div class="form-group">
                <label for="it8">Address</label>
                <h:inputText id="it8" value="#{managedBean.ownerRef1.address}"  styleClass="input-text"/>
            </div>
      
            <div class="form-group">
                <label for="it9">Occupation</label>
                <h:inputText id="it9" value="#{managedBean.ownerRef1.occupation}"  styleClass="input-text"/>
            </div>
      
            <div class="form-group">
                <label for="it10">Pincode</label>
                <h:inputText id="it10" value="#{managedBean.ownerRef1.pincode}"  styleClass="input-text"/>
            </div>
        </div>
      </div>
      ...
      <div class="buttons">
        <af:commandButton text="Delete" id="cb2"
                          action="#{managedBean.removeOwners}"  inlineStyle="font-family:Arial, Helvetica, sans-serif; font-size:x-large; color:Black !important; background-color:blue important; margin-left:10px; width:200.0px;margin-top:5px;"/>
      </div>
    </h:form>
  </div>
