  ...
  background-color: #555;
     ...
     <header>
            ...
            <div class="right-side">
                ...
                <a href="registrationVehicle.jsp" class="regheader">Registration</a>
  ...
  <div class="container">
    ...
    <af:form id="f1">
     <div class="form-group">
                ...
                <h:inputText styleClass="input-text" id="it1" value="#{managedBean.registration.registrationId}" style="width:580px"
                             required="true" />
            </div>
          <div class="form-group">
      <label for="vehicleId">Vehicle ID :</label>
           ...
           <div class="form-group">
                <label for="id1">Registration Date</label>
                   <af:inputDate id="id1" value="#{managedBean.registration.registrationDate}" required="true"/>
            </div>     
      <div class="form-group">
      <af:commandButton text="Register" id="cb1" 
                        action="#{managedBean.cb1_action}"  inlineStyle="font-family:Arial, Helvetica, sans-serif; font-size:x-large; color:Black !important; background-color:blue important; margin-left:200px; width:200.0px;margin-top:30px;">
