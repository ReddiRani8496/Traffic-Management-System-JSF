...
.vehicleheader {
  ...
  <div class="container">
    <h1 class="arvo-bold-italic">Remove Vehicle</h1>
    <h:messages   />
    <h:form id="f2">  
      ...
      <div class="form-row">
        <div class="form-column">
            ...
            <div class="form-group">
                ...
                <h:inputText styleClass="input-text" id="it1" value="#{managedBean.vehicleRef.vehicleId}"
                              />
            </div>
      
            <div class="form-group">
                 <label for="it2">Engine Number</label>
                <h:inputText  styleClass="input-text" id="it2" value="#{managedBean.vehicleRef.engineNumber}"/>
            </div>
      
            <div class="form-group">
              <label for="it3">Chassis Number</label>
                <h:inputText id="it3" value="#{managedBean.vehicleRef.chassisNumber}"  styleClass="input-text"/>
            </div>
      
            <div class="form-group">
                <label for="it4">Vehicle Type</label>
                <h:inputText id="it4" value="#{managedBean.vehicleRef.vehicleType}"  styleClass="input-text"/>
            </div>
        ...
        <div class="form-column">
         ...
         <div class="form-group">
                ...
                <af:inputDate id="id1" value="#{managedBean.vehicleRef.manufactureDate}"  styleClass="input-text"
        ...
        background-color: #F6F5F2;" />
            ...
            <div class="form-group">
                ...
                <h:inputText id="it7" value="#{managedBean.vehicleRef.manufacturerName}"  styleClass="input-text"/>
            </div>
      
            <div class="form-group">
                <label for="it8">Model</label>
                <h:inputText id="it8" value="#{managedBean.vehicleRef.model}"  styleClass="input-text"/>
            </div>
      
            <div class="form-group">
                <label for="it9">Variant</label>
                <h:inputText id="it9" value="#{managedBean.vehicleRef.variant}"  styleClass="input-text"/>
            </div>
      </div>
      </div>
      <div class="buttons">
        <af:commandButton text="Delete" id="cb1"
                          action="#{managedBean.removeVehicle}"   inlineStyle="font-family:Arial, Helvetica, sans-serif; font-size:x-large; color:Black !important; background-color:blue important; margin-left:20px; width:200.0px;margin-top:7px;"/>
      </div>
    </h:form>
  </div>
 <h:panelGroup>
